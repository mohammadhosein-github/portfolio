...
function About(){
    return(
        <section className="about-me my-section section-padding">
                ...
                <div className="row text-right">
                    ...
                    <div className="col-md-4">
                        <div className="my-card">
                            ...
                            <h4>دقت در جزئیات</h4>
                            <p>از نظر من جزئیات یک پروژه می&zwnj;تواند نشان&zwnj;دهنده جدیت و قابل اطمینام بودن آن باشد و به همین دلیل توجه به آن اهمیت ویژه ایی دارد</p>
                        </div>
                    </div>
                    <div className="col-md-4">
                        <div className="my-card">
